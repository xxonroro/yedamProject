...
public class BrandSort implements Control {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String brand = request.getParameter("brand"); // 상의 바지 아우터 신발 
		...
		List<ClothesVO> list = csv.brandsort(brand, orderby, searchword, page2, prod2);
		
		int a = csv.brandCount(brand);
