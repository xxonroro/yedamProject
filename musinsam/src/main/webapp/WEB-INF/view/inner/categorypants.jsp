...
<script>
$(input[class="pixel-radio"]).change(function(){
          ...
          <div class="sidebar-categories">
            ...
            <ul class="main-categories">
              <li class="common-filter">
                <form action="#">
                  <ul>
                    <li class="filter-list"><a href="categorypants.do"><input class="pixel-radio" type="radio" id="men" name="brand"><label for="men">Pants</label></a></li>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  <div class="card-product__img">
                    <img class="card-img" src="upload/${vo.clothName}.jpg" width="100px" height="150px"alt="">
                  ...
                  <div class="card-body">
                    <p><c:out value="${vo.smallCategory}"/></p>
                    <h4 class="card-product__title"><a href="#"><c:out value="${vo.clothName}"/></a></h4>
                    <p class="card-product__price"><c:out value="${vo.price}"/>원</p>
                  </div>
                </div>
              </div>
              </c:forEach>
