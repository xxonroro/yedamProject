   ...
   <section class="section-margin mt-0" id="sectionMain1">
     ...
     <div class="owl-carousel owl-theme hero-carousel" >
      ...
      <div class="hero-carousel__slide" id="divimg1">
         <img src="img/home/hero-slide1.png" alt="사진없음" class="img-fluid" height="300px">
       ...
       <div class="hero-carousel__slide" id="divimg2">
         <img src="img/home/hero-slide2.png" alt="사진없음" class="img-fluid"  height="300px">
         <a href="#" class="hero-carousel__slideOverlay">
           <h3>Wireless Headphone</h3>
       ...
       <div class="hero-carousel__slide" id="divimg3">
         <img src="img/home/hero-slide3.png" alt="사진없음" class="img-fluid"  height="300px">
         <a href="#" class="hero-carousel__slideOverlay">
           <h3>Wireless Headphone</h3>
   ...
   <!-- ================ trending product section start ================= -->  
    <section class="section-margin calc-60px">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 col-xl-3" id="divbody">
     
            <div class="card text-center card-product" id="prod">
    ...
    <section class="section-margin calc-60px" >
      <div class="container" id="contain">
        ...
        <div  class="owl-carousel owl-theme" id="bestSellerCarousel">
          <div id="maind">
          <div class="card text-center card-product" id="maind2">
