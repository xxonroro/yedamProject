			...
			<div class="col-md-10 offset-md-1" style="text-align: center;">
				<div class="site-blocks-table">
					<table class="table">
						<thead>
							<tr>
								<th class="order-date" style="font-size: 14px; padding: 20px 30px;">주문일</th>
								<th class="product-name" style="font-size: 14px; padding: 20px 30px;">주문 내역</th>
								<th class="order-status" style="font-size: 14px; padding: 20px 30px;">주문 번호</th>
								<th class="order-price" style="font-size: 14px; padding: 20px 30px;">결제금액</th>
							</tr>
						</thead>
						<tbody>
...
<script defer>
  ...
  .then(result => {
      ...
      result.forEach(order => {
        tbody.appendChild(makeRow(order));
      })
  })
  .catch(error => {
    console.error(error);
  ...
  function makeRow(order = {}) {
    ...
    fileds.forEach(field => {
      ...
      if(field == "clothName") {
        ...
        a.setAttribute("href", "getProduct.do?clothNo=" + order["clothNo"]);
